...
"
Script plots dCs Vs dCs breakdown variables (dCs,npp, dCs,tau etc) for CMIP5 and CMIP6 ESMs using the future SSP and RCP simulations.
"
...
fig_figure1 = plt.figure(1, figsize=(58,26))
gs = gspec.GridSpec(2, 4, figure=fig_figure1, hspace=1.8, wspace=0.5)
...
for model_i in range(0, n_models):
    ...
    plt.plot(cmip5_deltaCs_rcp26[model_i], cmip5_deltaCsRh_rcp26[model_i], color=model_colors_cmip5[model_i], marker=rcp_markers[0], markersize=30)
    plt.plot(cmip5_deltaCs_rcp45[model_i], cmip5_deltaCsRh_rcp45[model_i], color=model_colors_cmip5[model_i], marker=rcp_markers[1], markersize=30)
    plt.plot(cmip5_deltaCs_rcp85[model_i], cmip5_deltaCsRh_rcp85[model_i], color=model_colors_cmip5[model_i], marker=rcp_markers[2], markersize=30)
    
plt.xlabel(r'$\Delta C_{s}$ (PgC)')
...
for model_i in range(0, n_models):
    ...
    plt.plot(cmip5_deltaCs_rcp26[model_i], cmip5_deltaCstau_rcp26[model_i], color=model_colors_cmip5[model_i], marker=rcp_markers[0], markersize=30)
    plt.plot(cmip5_deltaCs_rcp45[model_i], cmip5_deltaCstau_rcp45[model_i], color=model_colors_cmip5[model_i], marker=rcp_markers[1], markersize=30)
    plt.plot(cmip5_deltaCs_rcp85[model_i], cmip5_deltaCstau_rcp85[model_i], color=model_colors_cmip5[model_i], marker=rcp_markers[2], markersize=30)
    
plt.xlabel(r'$\Delta C_{s}$ (PgC)')
plt.ylabel(r'$\Delta C_{s, \tau}$ (PgC)')
...
for model_i in range(0, n_models):
    ...
    plt.plot(cmip5_deltaCs_rcp26[model_i], cmip5_deltadelta_rcp26[model_i], color=model_colors_cmip5[model_i], marker=rcp_markers[0], markersize=30)
    plt.plot(cmip5_deltaCs_rcp45[model_i], cmip5_deltadelta_rcp45[model_i], color=model_colors_cmip5[model_i], marker=rcp_markers[1], markersize=30)
    plt.plot(cmip5_deltaCs_rcp85[model_i], cmip5_deltadelta_rcp85[model_i], color=model_colors_cmip5[model_i], marker=rcp_markers[2], markersize=30)
    
plt.xlabel(r'$\Delta C_{s}$ (PgC)')
plt.ylabel(r'$\Delta NPP \Delta \tau$ (PgC)')


ax = fig_figure1.add_subplot(gs[0, 3])
# for loop for each CMIP5 model
for model_i in range(0, n_models):
    model = cmip5_models[model_i] # seleting the models

    plt.plot(cmip5_deltaCs_rcp26[model_i], cmip5_NEPtau_rcp26[model_i], color=model_colors_cmip5[model_i], marker=rcp_markers[0], markersize=30)
    plt.plot(cmip5_deltaCs_rcp45[model_i], cmip5_NEPtau_rcp45[model_i], color=model_colors_cmip5[model_i], marker=rcp_markers[1], markersize=30)
    plt.plot(cmip5_deltaCs_rcp85[model_i], cmip5_NEPtau_rcp85[model_i], color=model_colors_cmip5[model_i], marker=rcp_markers[2], markersize=30)
    
plt.xlabel(r'$\Delta C_{s}$ (PgC)')
plt.ylabel(r'$\Delta C_{s, NEP}$ (PgC)')


#r_cmip5 = np.corrcoef([cmip5_deltaCstau_rcp26, cmip5_deltaCstau_rcp45, cmip5_deltaCstau_rcp85], [cmip5_deltaCsRh_rcp26, cmip5_deltaCsRh_rcp45, cmip5_deltaCsRh_rcp85])[0, 1]**2
#print(r_cmip5)        
...
leg1 = ax.legend(handles, labels, loc='lower center', ncol=5, borderaxespad=0.2, bbox_to_anchor=(-1.75, -1.2), title='CMIP5', fontsize=52)
...
leg2 = ax.legend(handles2, labels2, loc='lower center', ncol=3, borderaxespad=0.2, bbox_to_anchor=(-1.75, -1.6), fontsize=52)
...
for model_i in range(0, n_models):
    ...
    plt.plot(cmip6_deltaCs_ssp126[model_i], cmip6_deltaCsRh_ssp126[model_i], color=model_colors_cmip6[model_i], marker=ssp_markers[0], markersize=30)
    plt.plot(cmip6_deltaCs_ssp245[model_i], cmip6_deltaCsRh_ssp245[model_i], color=model_colors_cmip6[model_i], marker=ssp_markers[1], markersize=30)
    plt.plot(cmip6_deltaCs_ssp585[model_i], cmip6_deltaCsRh_ssp585[model_i], color=model_colors_cmip6[model_i], marker=ssp_markers[2], markersize=30)
...
for model_i in range(0, n_models):
    ...
    plt.plot(cmip6_deltaCs_ssp126[model_i], cmip6_deltaCstau_ssp126[model_i], color=model_colors_cmip6[model_i], marker=ssp_markers[0], markersize=30)
    plt.plot(cmip6_deltaCs_ssp245[model_i], cmip6_deltaCstau_ssp245[model_i], color=model_colors_cmip6[model_i], marker=ssp_markers[1], markersize=30)
    plt.plot(cmip6_deltaCs_ssp585[model_i], cmip6_deltaCstau_ssp585[model_i], color=model_colors_cmip6[model_i], marker=ssp_markers[2], markersize=30)
    
plt.xlabel(r'$\Delta C_{s}$ (PgC)')
plt.ylabel(r'$\Delta C_{s, \tau}$ (PgC)')


ax = fig_figure1.add_subplot(gs[1, 2])
# for loop for each CMIP6 model
for model_i in range(0, n_models):
    model = cmip6_models[model_i] # seleting the models

    plt.plot(cmip6_deltaCs_ssp126[model_i], cmip6_deltadelta_ssp126[model_i], color=model_colors_cmip6[model_i], marker=ssp_markers[0], markersize=30)
    plt.plot(cmip6_deltaCs_ssp245[model_i], cmip6_deltadelta_ssp245[model_i], color=model_colors_cmip6[model_i], marker=ssp_markers[1], markersize=30)
    plt.plot(cmip6_deltaCs_ssp585[model_i], cmip6_deltadelta_ssp585[model_i], color=model_colors_cmip6[model_i], marker=ssp_markers[2], markersize=30)
    
plt.xlabel(r'$\Delta C_{s}$ (PgC)')
plt.ylabel(r'$\Delta NPP \Delta \tau$ (PgC)')


ax = fig_figure1.add_subplot(gs[1, 3])
# for loop for each CMIP6 model
for model_i in range(0, n_models):
    model = cmip6_models[model_i] # seleting the models

    plt.plot(cmip6_deltaCs_ssp126[model_i], cmip6_NEPtau_ssp126[model_i], color=model_colors_cmip6[model_i], marker=ssp_markers[0], markersize=30)
    plt.plot(cmip6_deltaCs_ssp245[model_i], cmip6_NEPtau_ssp245[model_i], color=model_colors_cmip6[model_i], marker=ssp_markers[1], markersize=30)
    plt.plot(cmip6_deltaCs_ssp585[model_i], cmip6_NEPtau_ssp585[model_i], color=model_colors_cmip6[model_i], marker=ssp_markers[2], markersize=30)
    
plt.xlabel(r'$\Delta C_{s}$ (PgC)')
plt.ylabel(r'$\Delta C_{s, NEP}$ (PgC)')


#r_ssp126 = np.corrcoef(cmip6_deltaCstau_ssp126, cmip6_deltaCsRh_ssp126)[0, 1]**2
#r_ssp245 = np.corrcoef(cmip6_deltaCstau_ssp245, cmip6_deltaCsRh_ssp245)[0, 1]**2
#r_ssp585 = np.corrcoef(cmip6_deltaCstau_ssp585, cmip6_deltaCsRh_ssp585)[0, 1]**2
#print(r_ssp126, r_ssp245, r_ssp585)
#
#r_cmip6 = np.corrcoef([cmip6_deltaCstau_ssp126, cmip6_deltaCstau_ssp245, cmip6_deltaCstau_ssp585], [cmip6_deltaCsRh_ssp126, cmip6_deltaCsRh_ssp245, cmip6_deltaCsRh_ssp585])[0, 1]**2
#print(r_cmip6)
...
leg1 = ax.legend(handles, labels, loc='lower center', ncol=5, borderaxespad=0.2, bbox_to_anchor=(-1.75, -1.3), title='CMIP6', fontsize=52)
plt.gca().add_artist(leg1)
...
leg2 = ax.legend(handles2, labels2, loc='lower center', ncol=3, borderaxespad=0.2, bbox_to_anchor=(-1.75, -1.75), fontsize=52)
plt.gca().add_artist(leg2)
        

#%%
fig_figure1.savefig('figures/VsCs_cmip5cmip6_v1', bbox_inches='tight')
plt.close()